...
people might ask why this question and why now? I think there are two resaons:
...
the first workbook is to get a working knowldge of how a GRPO experiment works, a small LLM Qwen 2.5 0.5B - Instruct. to run and observe GSM8K
